...
class PetLostListScreen extends ConsumerStatefulWidget {
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [
            ...
            Tab(text: 'Meus Alertas', icon: Icon(Icons.person)),
          ],
        ),
      ),
      body: TabBarView(
...
class _AlertListBuilder extends ConsumerWidget {
  final AsyncValue<List<PetLostAlertEntity>> alertsState;
